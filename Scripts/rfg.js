...
(function ($) {
    ...
    rfg.init = function () {
        ...
        function quickFix () {
            var newWidth = parseInt($('.rfg-images').css('width'), 10),
                demoHeader = $('#header');
            if (newWidth < 400) {
                if(demoHeader.hasClass('WarpShadow')) {
                    demoHeader.removeClass('WarpShadow')
                }
            } else {
                if(!demoHeader.hasClass('WarpShadow')) {
                    demoHeader.addClass('WarpShadow')
                }
            }
            $('#header').css({
                'width': newWidth
