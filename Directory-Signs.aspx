<%@ Page Title="Directory Signs by City Signs – Modesto, Sacramento, Stockton, Tracy, CA – ADA, Map, Marquee" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="Directory-Signs.aspx.cs" Inherits="CitySigns.Directory_Signs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h4 style="padding-left: 20px;"><img src="/Images/bullet_arrow.png" /> DIRECTORY SIGNS GALLERY</h4>
